...
func (x *Command) GetPutReq() *PutRequest {
...
func (x *Command) GetDeleteReq() *DeleteRangeRequest {
...
func (x *Command) GetTxnReq() *TxnRequest {
...
func (x *Command) GetIncrReq() *IncrementRequest {
...
type Command_PutReq struct {
	PutReq *PutRequest `protobuf:"bytes,2,opt,name=put_req,json=putReq,proto3,oneof"`
}

type Command_DeleteReq struct {
	DeleteReq *DeleteRangeRequest `protobuf:"bytes,3,opt,name=delete_req,json=deleteReq,proto3,oneof"`
}

type Command_TxnReq struct {
	TxnReq *TxnRequest `protobuf:"bytes,4,opt,name=txn_req,json=txnReq,proto3,oneof"`
}

type Command_IncrReq struct {
	IncrReq *IncrementRequest `protobuf:"bytes,5,opt,name=incr_req,json=incrReq,proto3,oneof"`
}
...
var file_kv_store_proto_rawDesc = []byte{
	...
	0x12, 0x0a, 0x0a, 0x06, 0x4e, 0x55, 0x4d, 0x42, 0x45, 0x52, 0x10, 0x01, 0x42, 0x3b, 0x0a, 0x2b,
	0x6f, 0x72, 0x67, 0x2e, 0x61, 0x70, 0x61, 0x63, 0x68, 0x65, 0x2e, 0x62, 0x6f, 0x6f, 0x6b, 0x6b,
	0x65, 0x65, 0x70, 0x65, 0x72, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2e, 0x6b, 0x76, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x50, 0x01, 0x5a, 0x0a, 0x74,
...
var file_kv_store_proto_goTypes = []interface{}{
	...
	(*PutRequest)(nil),         // 6: bookkeeper.proto.kv.rpc.PutRequest
	(*DeleteRangeRequest)(nil), // 7: bookkeeper.proto.kv.rpc.DeleteRangeRequest
	(*TxnRequest)(nil),         // 8: bookkeeper.proto.kv.rpc.TxnRequest
	(*IncrementRequest)(nil),   // 9: bookkeeper.proto.kv.rpc.IncrementRequest
}
